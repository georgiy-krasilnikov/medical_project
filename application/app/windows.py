...
choice_window = sg.Window('Интеллектуальная система ЦТО', layouts[3], element_justification='c', size=(900, 550))
class_window = sg.Window('Интеллектуальная система ЦТО', layouts[4], element_justification='c', size=(500, 350))
